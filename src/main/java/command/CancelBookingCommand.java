...
public class CancelBookingCommand implements ICommand {
    ...
    public void execute(Context context) {
        ...
        System.out.println("Current booking number: " + currentBooking.getBookingNumber());
        ...
        System.out.println("1 day before booking: " + currentBooking.getEventPerformance().getStartDateTime().minusDays(1));
